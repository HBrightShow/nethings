...
public:
	int m_threadnum;                    //�̳߳��п����̵߳ĸ���
	int m_QueueMaxNum;                //���������job�ĸ���
	struct job *m_head;                 //ָ��job��ͷָ��
	struct job *m_tail;                 //ָ��job��βָ��
	pthread_t  *m_pthreads;       		 //�̳߳��������̵߳�pthread_t
	pthread_mutex_t m_mutex;            //�����ź���
	pthread_cond_t m_cond_QueueEmpty;       //����Ϊ�յ���������
	pthread_cond_t m_cond_QueueNotEmpty;   //���в�Ϊ�յ���������
	pthread_cond_t m_cond_QueueNotFull;    //���в�Ϊ������������
	int m_CurQueueJobNum;                //���е�ǰ��job����

	bool m_PoolIsClose;                   //�̳߳��Ƿ��Ѿ��ر�
